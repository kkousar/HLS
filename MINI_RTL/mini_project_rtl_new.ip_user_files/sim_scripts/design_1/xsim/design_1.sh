...
elaborate()
{
  xelab --relax --debug typical --mt auto -L xlconstant_v1_1_3 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot design_1 xil_defaultlib.design_1 xil_defaultlib.glbl -log elaborate.log
}
